      ...
      <PageWrap>
        <div class="flex flex-col gap-4 items-center bg-[#ffc040] rounded-lg p-5">
          ...
          <div class="text-center">
            Atenção: O plano de serviço do paciente está desativado. Ative o
            plano em "Minha Conta" para continuar disponibilizando suas
        ...
        {publicProfile.name
            ...
            <div class="flex flex-col items-center gap-5 max-w-[95%]">
                ...
                ? (
                  <div class="flex flex-col p-4 text-white rounded-md items-center gap-4 bg-[#da8f0f] text-xs">
                    ...
                    <span>
                      ...
                      carteirinha digital do ecanna não é mais oferecido de
                      forma gratuita.
                    </span>
                    <span>
              ...
              <div class="bg-gray-200 p-2 rounded-md leading-3 flex items-center gap-3">
                ...
                <span class="text-[10px] text-[#333]">
                  ...
                  medicinal disponibilizem seus documentos de forma facilitada,
                  caso haja qualquer necessidade de fiscalização. A condição de
                  paciente se respalda exclusivamente na validade dos documentos
          ...
          : (
            <div class="join w-full flex justify-center flex-col items-center gap-5">
              <span>
                Requisite ao paciente o número do PIN, presente na área interna
                de gestão da carteirinha, para visualizar as informações
              </span>
